...
import com.yobn.plugin.manager.LPluginDexManager;
...
///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void bindDexLoader(Context ctx){
        pluginLoader = LPluginDexManager.getClassLoader(pluginPath,ctx,LPluginDexManager.getSystemLoader() == null ? ctx.getClassLoader() : LPluginDexManager.getSystemLoader());
    }
