...
import com.plugin.LPluginTool;
import com.plugin.bean.LAPK;
...
import com.plugin.reflect.Reflect;
...
public final class LApkManager {
    ...
    private static void fillPluginInfo(LAPK apk ,Context ctx) {
        ...
        if (info == null) {
            throw new PluginCreateFailedException("Can't create Plugin from :" + apk.pluginPath);
        }
    ...
    private static void fillPluginApplication(LAPK apk ,Context ctx) {
        ...
        if (applicationName.isEmpty()) return;
