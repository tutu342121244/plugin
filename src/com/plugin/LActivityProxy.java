...
public class LActivityProxy extends Activity implements ILoadPlugin
{
    ...
    protected void onCreate(Bundle savedInstanceState)
	{
        ...
        try
		{
        	...
        	if(bundle!=null&&!TextUtils.isEmpty(bundle.getString("token"))&&!TextUtils.isEmpty(bundle.getString("mc_id"))){
            	if(savedInstanceState==null){
            		savedInstanceState=bundle;
        		}else{
        			savedInstanceState.putString("token", bundle.getString("token"));
        			savedInstanceState.putString("mc_id", bundle.getString("mc_id"));
        		}
        	}
